...
CREATE TABLE file_upload (
                             ...
                             processing_status VARCHAR(20) DEFAULT 'PENDING' COMMENT '异步处理状态(PENDING/PARSING/VECTORIZING/COMPLETED/FAILED)',
                             processing_error TEXT DEFAULT NULL COMMENT '异步处理失败原因',
                             processing_updated_at TIMESTAMP NULL DEFAULT NULL COMMENT '异步处理状态更新时间',
