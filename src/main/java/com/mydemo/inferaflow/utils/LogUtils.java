package com.mydemo.inferaflow.utils;
...
public class LogUtils {
    ...
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.mydemo.inferaflow.business");
    
    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.mydemo.inferaflow.performance");
